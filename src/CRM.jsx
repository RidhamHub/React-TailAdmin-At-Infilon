...
function Crm() {
  return (
    <div className="p-7 bg-gray-50 ">
      {/* first 3 card  */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3   gap-5 w-auto">
        <CardCrm
          price="$120,369"
          text="Active Deal"
          percent="+20"
      ...
      <div className="flex flex-col justify-between lg:flex-row gap-7 mt-7 ">
        {/* Sales Category  */}
      ...
      <div className="overflow-x-scroll">
        <div className="crmtable mt-7 py-7 border border-gray-300 rounded-2xl bg-white">
          <div className="px-7">
